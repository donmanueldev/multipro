...
| Color | HEX | Uso |
|---|---|---|
| Verde principal | `#007F73` | M, secciones de marca y fondos de apoyo |
...
1. Mantener alrededor del logo un espacio libre equivalente al grosor del asta vertical de la M.
2. Conservar la M verde, la P coral y una sola cuña violeta.
3. No agregar colores, fragmentos, contornos, sombras ni efectos.
4. En tamaños pequeños usar únicamente el símbolo MP.
5. Para fondos oscuros utilizar la variante invertida.
6. No deformar, inclinar ni reorganizar el monograma.
7. Antes de publicar una portada, revisar los recortes reales de escritorio y teléfono.
...
### PNG/JPG listos para usar

- `facebook-perfil-1080.png`
...
Identidad aprobada para material digital. Antes de producir uniformes, rótulos o empaques en volumen, validar una prueba física del verde, coral y violeta con el proveedor de impresión.
